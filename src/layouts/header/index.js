            ...
            <div className="flex py-[6px]">
                ...
                <div className="flex  child:flex child:items-center ml-auto mr-[4px]">
                    <div className='hover:bg-[#808081] mx-[4px]'>
                        ...
                        <input type='text' placeholder='Search' className="h-full outline-none bg-[#6d6d6f] border-[1px] border-rounded pl-[30px] pr-[12px] placeholder:text-white border-[#777779]"  />
                    </div>
                    ...
                    <img className="h-[32px] w-[32px] leading-[32px] rounded-[50%]" src='https://lh3.googleusercontent.com/ogw/AOh-ky3zqWtXF7Tul9sD7dGTvW3frA5OmFiIPBTAw7Wf=s32-c-mo'></img>
                </div>
