const SideBarNav = () => {
  return (
    <>
      <div>
        <div className="pt-[12px] child:flex child:pl-[16px] child:flex-row child:h-[32px] child:items-center">
          {/* board */}
          <a>
            <span className="flex flex-row items-center justify-center pr-[8px] w-[24px] h-[20px]">
              <svg
                width="24"
                height="24"
                role="presentation"
            ...
            <p className="text-white pl-[12px] flex-1">Board</p>
          </a>
          {/* menber */}
          <a>
            <span className="flex flex-row items-center justify-center pr-[8px] w-[24px] h-[20px]">
            ...
            <p className="text-white pl-[12px] flex-1">Members</p>
            <button className="p-[4px] mx-[6px]">
              <svg
                width="16"
                height="16"
                role="presentation"
          ...
          <a className="py-[6px] pr-[10px]">
            ...
            <p className="text-white pl-[12px] flex-1">Settings</p>
            <span>
              <svg
                width="16"
                height="16"
