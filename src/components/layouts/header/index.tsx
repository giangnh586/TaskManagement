...
const Header = () => {
  return (
    <div className="bg-[#49494b]">
      <div className="flex py-[6px] px-[4px]">
        ...
        <button className="flex child:flex items-center hover:bg-[#808081] px-[6px]">
          ...
          <span className="font-bold text-white mx-2 text-[16px]">Trello</span>
        </button>
        ...
        <div className="flex  child:flex child:items-center ml-auto mr-[4px]">
          ...
          <div className="hover:bg-[#808081] mx-[4px]">
            ...
            <input
              type="text"
              placeholder="Search"
              className="h-full outline-none bg-[#6d6d6f] border-[1px] rounded pl-[30px] pr-[12px] placeholder:text-white border-[#777779]"
            />
          </div>
          
          {/* bell icon */}
          <button className="hover:bg-[#808081] mr-[4px] h-[32px] w-[32px] flex justify-center">
            <span>
            <svg
              width="24"
              height="24"
